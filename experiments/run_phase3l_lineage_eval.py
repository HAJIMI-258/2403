"""Run Phase 3L strict vs lineage vs binding summaries."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Phase 3L lineage / binding evaluation summary.")
...
def main() -> None:
    ...
    eval_rows = build_phase3l_eval_rows(rows)

    summary_path = output_dir / f"phase3l_lineage_eval_summary_{args.artifact_version}.csv"
    figure_path = output_dir / "strict_vs_lineage_vs_binding_eval_v1.png"
    write_csv(summary_path, eval_rows)
    plot_strict_vs_lineage_vs_binding_eval(eval_rows, figure_path)
