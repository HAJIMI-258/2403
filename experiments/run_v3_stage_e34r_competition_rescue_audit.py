...
from experiments.run_v3_stage_e34r_support_trajectory_refinement import run


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run v3 Stage E3.4r competition rescue audit.")
